...
/*!< API functions */
static inline ksint32_t fwk_i2c_add_device(struct fwk_i2c_client *sprt_client)
{
	return fwk_register_i2c_device(sprt_client);
}

static inline ksint32_t fwk_i2c_del_device(struct fwk_i2c_client *sprt_client)
{
	return fwk_unregister_i2c_device(sprt_client);
}

static inline ksint32_t fwk_i2c_add_driver(struct fwk_i2c_driver *sprt_driver)
{
	return fwk_i2c_register_driver(sprt_driver);
}

static inline ksint32_t fwk_i2c_del_driver(struct fwk_i2c_driver *sprt_driver)
{
