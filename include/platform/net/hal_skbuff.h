...
#ifndef __HAL_SKBUFF_H_
#define __HAL_SKBUFF_H_
...
struct hal_sk_buff
{
    ...
    struct hal_sk_buff *sprt_next;                                  /*!< doubly list, pointing to the latter sk_buff */
    struct hal_sk_buff *sprt_prev;                                  /*!< doubly list, pointing to the previous sk_buff */

    struct hal_net_device *sprt_netdev;                             /*!< net_device */
