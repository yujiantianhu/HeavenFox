...
{
	kint32_t (*match)(struct fwk_irq_domain *sptr_domain, struct fwk_device_node *sptr_intc);
	kint32_t (*map)(struct fwk_irq_domain *sptr_domain, kuint32_t virq, kuint32_t hw);
	void (*unmap)(struct fwk_irq_domain *sptr_domain, kuint32_t virq);
